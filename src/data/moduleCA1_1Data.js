      ...
      "data": {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "style": "warn",
            "icon": "⚠",
            "text": "**Disengagement specifics (the actual paperwork, the wellness check-in, the inappropriate-interaction protocol) are covered in a later module.** For now, your job is to recognize the GCL and FNL triggers and set those tasks for your Assistant Manager at the right times. The Assistant Manager handles the rest."
          }
        ]
      }
    },
        ...
        "steps": [
          {
            ...
            "correctIndex": 1,
            "feedback": "Set a GCL task for the Assistant Manager, then resume the cadence. The 4-attempt threshold is the GCL trigger per the SOP. Maya doesn't *stop* her own cadence while the GCL is in flight; she keeps Follow-Up #5 scheduled for two weeks out (Tier 1 cadence). FNL is the 8-attempt threshold, not the 4-attempt one. \"No Case — Unresponsive\" comes after FNL with no response."
          },
          {
