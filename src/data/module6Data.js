// Auto-generated by Edit Mode — 2026-04-28T19:19:51.922Z
  ...
  "cards": [
    {
      ...
      "data": {
        ...
        "headline": "Not Every Claim Follows the Standard PI Journey",
        "body": [
          ...
          "Meet Victor. Victor is a retired attorney and former teacher from South Harlem. His wife Veronique was an NYPD officer who responded to Ground Zero on September 11, 2001, and worked the site for two weeks — twelve-hour shifts, six days a week. She was diagnosed with lung cancer in 2018 and passed away in 2022. Veronique never enrolled in the WTC Health Program and her condition was never certified as 9/11 related.",
          "Victor is able to file a claim on Veronique's behalf, but his claim journey will look different than Yajaira's."
        ],
        "closing": "This module covers case types that require a different approach: living claimants who cannot obtain WTCHP certification, deceased claimants, and claimants whose health or financial situation cannot demand a faster response.",
        "objectives": [
          "The FA claim — the Personal Representative appointment process and FA-specific requirements",
          "The Private Physician Process (PPP) — when it's used and what it requires",
          "POP and illness documentation for the PPP",
          "The Expedite pathway — what triggers an expedite and the basics of the pathway",
          "What necessitates a non-standard claim pathway"
        ],
    ...
    },
    {
      ...
      "data": {
        ...
        "intro": "A Family Assistance claim is a VCF claim filed on behalf of someone who has passed away. The process parallels a PI claim in many ways: evidence must demonstrate the diagnosis of qualified illness within the time restrictions, exposure to 9/11 toxins, and presence in the VCF exposure area. However, because the claimant has passed, a **Personal Representative (PR)** must be appointed to act on behalf of the deceased victim. Any required documents or evidence must be collected by those who knew the victim or by Barasch & McGarry.",
        "blocks": [
          {
            "type": "subheading",
          ...
          {
            "type": "paragraph",
            "text": "Before an FA claim can proceed, the estate must have a court-appointed Personal Representative. The process of PR appointment varies by state and depends on the presence, or lack, of a will. In New York State, two primary PR appointment documents may be issued:"
          },
          {
            "type": "paragraph",
            "text": "**Letters Testamentary** — issued when the deceased left a will (a \"testate\" estate). Generally the court confirms the executor named in the will as the PR."
          },
          {
            "type": "paragraph",
          ...
          },
          {
            ...
            "items": [
              ...
              {
                "time": "6th",
                "desc": "Other relations or interested parties"
              }
            ]
          },
          {
          ...
          {
            "type": "paragraph",
            "text": "The FA intake kit includes everything in the PI kit plus additional documents specific to the deceased claim: information about the decedent's family and household, and a general HIPAA release so we can begin requesting medical records on the decedent's behalf."
          },
          {
            "type": "paragraph",
            "text": "The VCF Signature Page in an FA claim requires an initial on the line reserved for those filing on behalf of the deceased, the line that should be left blank for a living claim.."
          },
          {
            "type": "subheading",
          ...
          },
          {
            ...
            "style": "info",
            "icon": "📋",
            "text": "When a PI client passes during the claim process, the account is generally transferred to the FA Team. **An FA claim has a different VCF identification number** and is filed by the victim's Personal Representative — the PR is our client. Some of the work done during the PI claim process, especially if the client was able to get certified by the WTCHP, can help the FA team more easily submit the claim. But every FA conversion is vetted for viability by an FA Client Acquisition Team member or attorney, and additional documents — including all new authorization documents with the new VCF number, signed by the PR — must be collected through the collection of the FA Intake Kit.  If any client passes during the claim process, please consult the Death Summary SOP in the Company Wide Procedures folder in sSarepoint for more information."
          }
        ]
      }
    },
    {
      ...
      "data": {
        ...
        "intro": "POP requirements for FA claims follow the same rules as PI claims — the same preference for primary evidence, the same EVL/TPV standard, the same witness rules. The challenge is that the victim is not available to describe their own presence, complete a Victim Attestation, or identify potential witnesses.  ",
        "blocks": [
          {
            "type": "subheading",
    ...
    },
    {
      ...
      "data": {
        ...
        "intro": "Veronique was an NYPD officer who worked at Ground Zero from September 11, 2001 through September 24, 2001 — twelve-hour shifts, six days a week. She was diagnosed with lung cancer in 2018 and passed away in 2022. She had a will naming Victor as executor. She was never enrolled in the WTCHP and was never certified for any condition. Victor has provided medical records showing the initial lung cancer diagnosis in 2018.",
        "steps": [
          {
            "text": "Victor and Veronique both lived in New York when Veronique passed. Victor needs to be recognized as the legal representative of Veronique's estate before the VCF will process the claim.",
            "question": "What does this require?",
            "options": [
              "Victor can file the VCF Claim immediately as the surviving spouse — no court appointment is needed.",
              "Victor needs to be appointed as Veronique's Personal Representative.  Since there is a will, this process should produce Letters Testamentary. ",
              "Victor needs an Affidavit of Distributee because the estate is being administered by a surviving spouse.",
              "A notarized statement from Victor confirming he is the surviving spouse and executor will allow him to submit the claim, but he would not be able to submit an eyewitness Victim Presence Statement because he is a family member."
            ],
            "correctIndex": 1,
            "feedback": "Because Veronique left a will naming Victor as executor, the estate is testate. In New York State, the surrogate's court should confirm the executor, usually the person named in the will, and issue Letters Testamentary. The Surrogates team at B&M handles New York State Personal Representative appointments, but this process can take months, even with a will."
          },
          {
            ...
            "options": [
              ...
              "A pre-2011 NOP is equivalent to one non-family eyewitness WPS. We should also seek witness statements that confirm Veronique's hours of exposure to support the PPP.",
              "Two full eyewitness WPS are needed — the NOP should not be submitted since primary evidence is not required for FA claims, especially for responders.",
              "NYPD has a direct VCF relationship — no POP needed."
            ],
            "correctIndex": 1,
            "feedback": "The pre-2011 NOP carries the weight of one non-family eye-witness WPS. However, because we are using the PPP to establish Veronique's illness, and the PPP requires exposure hours, we should collect a WPS from her colleagues that speak specifically to the hours she was on-site each day. The NOP establishes presence and responder status; the witness statements fill in the hours detail the PPP needs."
          },
          {
            "text": "Veronique was never certified by the WTCHP and cannot enroll now. The medical records Victor provided show her lung cancer was diagnosis in 2018.",
            "question": "What pathway is needed to establish her illness for the VCF claim?",
            "options": [
              "The WTCHP will accept medical records directly for FA claims — no additional process is needed.",
              "Vicor must submit medical records and additional documents required for the Private Physician Process (PPP) directly to the VCF.",
              "The claim cannot proceed without WTCHP certification — no exceptions apply to deceased claimants.",
              "Victor can request emergency post-mortem WTCHP enrollment on Veronique's behalf once he is appointed as PR."
            ],
            "correctIndex": 1,
            "feedback": "The Private Physician Process is used precisely for this situation: a deceased claimant who was never certified by the WTCHP and cannot enroll. Veronique's case has its challenges. With no EVL easily available and the PPP requiring exposure hours, collecting detailed witness statements from her colleagues is critical. Any other documentation showing she was in the area - tax records, dispatch records, police log book pages - should also be gathered."
          }
        ]
      }
    },
    {
      ...
      "data": {
        ...
        "intro": "The Private Physician Process is the mechanism the VCF uses to evaluate a claimant's condition when WTCHP certification is not available. It is used only in limited circumstances, uncertified deceased claimants being the most common.",
        "blocks": [
          {
            "type": "subheading",
          ...
          },
          {
            ...
            "items": [
              {
                "time": "FA claims",
                "desc": "A deceased claimant who was never certified by the WTCHP for the claimed condition"
              },
              {
                "time": "Foreign residents",
                "desc": "A claimant who lives outside the country and cannot access the WTCHP"
              },
              {
                "time": "Ineligible for WTCHP",
                "desc": "A claimant who does not qualify for WTCHP enrollment (A commuter, for example)"
              },
              {
                "time": "Hardship",
                "desc": "A claimant who cannot travel to a WTCHP clinic without significant hardship"
              },
              {
                "time": "Pentagon/Shanksville",
                "desc": "Survivors eligible for the VCF but not the WTCHP"
              },
              {
                "time": "Extremis",
                "desc": "Cases where the standard certification timeline is too slow"
              }
            ]
          },
          {
            ...
            "cards": [
              {
                "abbr": "Cover Sheet",
                "color": "#009bdf",
                "desc": "The Private Physician Cover Sheet — the VCF's form summarizing the basis for PPP review.",
                "notes": []
              },
              {
    ...
    },
    {
      ...
      "data": {
        ...
        "intro": "The standard VCF claim process takes time; enrollment and certification can take months, VCF review and award can take another 1 - 2 years.  Some clients do not have the luxury of that kind of time. The Expedite pathway exists to move claims forward as quickly as possible.",
        "blocks": [
          {
            "type": "subheading",
            "text": "Primary expedite triggers"
          },
          {
            "type": "tier-cards",
            "tiers": [
              {
                ...
                "items": [
                  ...
                  "If a client mentions worsening health, new metastasis or complications, or a prognosis of a year or less, note it and escalate to your supervisor immediately"
                ]
              },
              {
                ...
                "border": "#e8d5b0",
                "items": [
                  "A claimant in active treatment for their illness",
                  "A claimant about to have a major surgery",
                  "Sometimes this may just warrant an expedited WTCHP Process"
                ]
              },
              {
          ...
          {
            "type": "paragraph",
            "text": "For living claimants who are already WTCHP-enrolled, expedite primarily means accelerated VCF review and priority processing once the claim is submitted. The WTCHP may also prioritize certification for terminal clients or clients needing active treatment."
          },
          {
            "type": "paragraph",
            "text": "For terminal clients who are not yet enrolled and whose health may not allow them to wait for the WTCHP enrollment and certification process, the PPP may be used to establish the illness for VCF purposes without waiting for WTCHP certification. The claimant may still pursue enrollment and certification through the WTCHP so they can receive treatment coverage — but that would be a parallel process to the VCF claim and generally requires specific action from our firm's Designated WTCHP Representative."
          },
          {
            "type": "subheading",
    ...
    },
    {
      ...
      "data": {
        ...
        "options": [
          "This is an FA claim. Because she was certified by the WTCHP before her death, the PPP is not needed.",
        ...
        "correctIndex": 0,
        "feedbackCorrect": "This is an FA claim. The claimant is deceased and the widower is the court-appointed PR with Letters of Administration. The critical distinction is certification: she was certified by the WTCHP before her death, which means the PPP is not needed. The certification remains valid for VCF purposes. Whether this qualifies as wrongful death depends on whether esophageal cancer was the cause of death — worth confirming with the PR and seeing if it is listed as a cause of death on the death certificate.",
        ...
        "questions": [
          {
            ...
            "options": [
              ...
              "Letters of Administration issued by the surrogate's court.",
              "Letters Testamentary issued by the surrogate's court confirming an executor named in a will.",
              "An affidavit of distributee, which grants authority to file the VCF claim directly."
            ],
            "correctIndex": 1
          },
          {
            ...
            "options": [
              "The VCF accepts sworn statements from friends and family attesting the decedent suffered from 9/11 related illnesses.",
          ...
          },
          {
            ...
            "options": [
              ...
              "Two eyewitness WPS are still required alongside the EVL — an EVL cannot satisfy the PPP on its own.",
              "The EVL or TPV is not viable for Pentagon survivor claims."
            ],
            "correctIndex": 1
          },
          {
            "question": "During a routine status update call, a client with an unsubmitted VCF claim mentions that his doctor told him he has \"maybe a year left.\" He asks if there's anything that can be done. What is the correct response?",
            "options": [
              "Explain that once a claim is submitted, the VCF controls the timeline and there's nothing B&M can do to accelerate it.",
              "Note the update in Salesforce and reach out to the client's clinic to confirm details.",
              "Escalate to your supervisor or team attorney immediately — a prognosis of approximately one year is an expedite trigger. ",
              "Advise the client to contact the VCF helpline directly to request priority review."
            ],
            "correctIndex": 2
          },
          {
            ...
            "options": [
              ...
              "She qualifies for the Private Physician Process as a foreign resident who cannot access the WTCHP.",
              "She should attempt to travel to a WTCHP clinic. There are no exceptions for foreign residents.",
