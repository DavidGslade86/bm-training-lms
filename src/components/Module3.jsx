...
export default function Module3({ learner, moduleStartedAt, onHome, onSignIn, editMode, onExitEditMode, forceReview = false }) {
  ...
  const { cards: mergedCards, updateCard, resetModule, hasEdits, editCount } = useEditableContent(MODULE_ID, MODULE3.cards);
  ...
  // Export merged card data as a drop-in src/data/module3Data.js replacement
  const exportDataFile = () => {
    const content = `// Auto-generated by Edit Mode — ${new Date().toISOString()}\n// Drop this file into src/data/ and rebuild to make edits permanent.\nexport const MODULE3 = ${JSON.stringify({ cards }, null, 2)};\n`;
    const blob = new Blob([content], { type: "text/javascript" });
    const url  = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url; a.download = "module3Data.js";
    a.click(); URL.revokeObjectURL(url);
  };

  const handleReset = () => {
    if (window.confirm("Reset all edits for Module 3? This will discard all in-browser changes and cannot be undone.")) {
      resetModule();
    }
  };
  ...
  return (
    <Ctx.Provider value={{
      ...
      cards,
      moduleId:    "module-3-sign-up-to-submitted",
      moduleTitle: "Module 3: From Sign-Up to Submitted",
      ...
      <div className="min-h-screen bg-brand-cream">
        ...
        <div className="flex" style={{marginTop: topOffset}} /* dynamic: offset for fixed nav + optional banner */>
          ...
          <div
            ...
            /* dynamic: shift down with banner, shift up with toolbar */
          >
                ...
                <div key={c.id}
                  ...
                  <div className="flex items-center gap-1 min-w-0 flex-1">
                    {isEditingNav ? (
                      ...
                      <>
                        <span className="text-xs truncate" style={{color: act ? "white" : "rgba(255,255,255,0.55)"}} /* dynamic: active-state text color */>{c.nav}</span>
                        {effectiveEditMode && (
                          <span
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                style={{ background: "white", border: "1.5px solid #fcd34d", color: "#92400e" }}
                title="Download module3Data.js to drop into src/data/"
              >
                ⬇ Export .js
              </button>
              <button
