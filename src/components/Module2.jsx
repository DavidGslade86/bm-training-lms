...
export default function Module2({ learner, moduleStartedAt, onHome, onSignIn, editMode, onExitEditMode, forceReview = false }) {
  ...
  const { cards: mergedCards, updateCard, resetModule, hasEdits, editCount } = useEditableContent(MODULE_ID, MODULE2.cards);
  ...
  // Export merged card data as a drop-in src/data/cards.js replacement
  const exportDataFile = () => {
    const content = `// Auto-generated by Edit Mode — ${new Date().toISOString()}\n// Drop this file into src/data/ and rebuild to make edits permanent.\nexport const MODULE2 = ${JSON.stringify({ cards }, null, 2)};\n`;
    const blob = new Blob([content], { type: "text/javascript" });
    const url  = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url; a.download = "module2Data.js";
    a.click(); URL.revokeObjectURL(url);
  };

  const handleReset = () => {
    if (window.confirm("Reset all edits for Module 2? This will discard all in-browser changes and cannot be undone.")) {
      resetModule();
    }
  };
  ...
  // Layout offsets: nav=52px, banner(review or edit)=32px
  const hasBanner = effectiveReviewMode;
  const topOffset = hasBanner ? 84 : 52;
  // Edit toolbar is 48px at bottom
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                style={{ background: "white", border: "1.5px solid #fcd34d", color: "#92400e" }}
                title="Download cards.js to drop into src/data/"
              >
                ⬇ Export .js
              </button>
              <button
